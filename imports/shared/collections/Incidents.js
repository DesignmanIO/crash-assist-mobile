...
const Incidents = Meteor.collection('incidents');//new Mongo.Collection("incidents");
...
Incidents.simpleSchema = () => Schemas.Incidents;

const formSchema = new SimpleSchema({
    //driver info
    "driverInfo.licensePhoto": {type: Array},
    ...
    //[passenger info]
    "passengerInfo": {type: Array, optional: true},
    ...
    //insurance info
    "insuranceInfo.photo": {type: Array},
    ...
    //Witness Information
    "witnessInfo": {type: Array, optional: true},
    ...
    "sketch": {type: Array, optional: true},
    //array of photo public ids
    "photos": {type: Array, optional: true},
    //injuries
    "injuries": {type: Array, optional: true},
    //Symptoms
    "symptoms": {type: String, optional: true}
});

Incidents.simpleSchema =  () => Incidents.simpleSchema.extend(formSchema);
